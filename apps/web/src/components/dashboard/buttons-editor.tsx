...
const GROUPS: Array<{ title: string; keys: KeyDef[] }> = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "paySol", emoji: "", label: { vi: "Thanh toán USDT (Solana)", en: "Pay with USDT (Solana)", th: "ชำระด้วย USDT (Solana)" } },
      { key: "payTon", emoji: "", label: { vi: "Thanh toán USDT (TON)", en: "Pay with USDT (TON)", th: "ชำระด้วย USDT (TON)" } },
      { key: "payPaypal", emoji: "🅿️", label: { vi: "Thanh toán PayPal", en: "Pay with PayPal", th: "ชำระด้วย PayPal" } },
